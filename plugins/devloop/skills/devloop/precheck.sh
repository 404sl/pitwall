...
for l in ("needs-decision","needs-call","needs-access","needs-feedback","blocked-tooling","watch","umbrella","roadmap"):
...
if "left unlabelled" in text or "removing it again" in text or "removing again" in text:
    pass
elif not (labels & {"needs-decision","needs-call","needs-access","needs-feedback","blocked-tooling","watch","umbrella","roadmap"}):
